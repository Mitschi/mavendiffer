...
public class TagMatcherTests {
	private static final String PATH_PREFIX="/Users/chris/Documents/workspaceBuildChangeDifferVariants/semantic-differ/differ-maven-differ/poms/verifyThese/tagMatcher/";
	private File oldTmpFile;
	private File newTmpFile;
	private List<Change> expectedChanges;
	
	public TagMatcherTests(File oldTmpFile, File newTmpFile,List<Change> expectedChanges) {
